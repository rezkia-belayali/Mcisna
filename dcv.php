...
<header id="header" class="fixed-top">
  ...
  <main id="main">
    ...
    <div class="breadcrumbs" >
      <div class="container">
        <h2>Villages</h2>
        <p> Outre son chef-lieu Sidi Saïd, la commune de M'cisna est composée à sa création des localités suivantes : Amagaz, Tighermine, Ighil Ouantar, Ighil Melloulen, Imoula, Iazouzène, Sidi said. </p>
      </div>
    </div><!-- End Breadcrumbs -->
      ...
      <div class="container" >
        ...
        <div class="row">
          <div class="col-lg-6 order-1 order-lg-2" >
            <img src="assets/img/ljame3.jpg" class="img-fluid" alt="">
          </div>
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content">
            <h3>Bienvenue dans le site Officiel de l'APC </h3>
            <p class="fst-italic">
        ...
        <div class="testimonials-slider swiper-container">
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <div class="testimonial-wrap">
                <div class="testimonial-item">
                  <img src="assets/images/thighermine.jpg" class="testimonial-img" alt="">
                  <h3>chef-lieu</h3>
                  <h4>Ceo &amp; Founder</h4>
                  <p>
            ...
            <div class="swiper-slide">
              <div class="testimonial-wrap">
                <div class="testimonial-item">
                  <img src="assets/images/Immoula.jpeg.jpg" class="testimonial-img" alt="">
                  <h3>Amagaz</h3>
                  <h4>Designer</h4>
                  <p>
                    <i class="bx bxs-quote-alt-left quote-icon-left"></i>
            ...
            <div class="swiper-slide">
              <div class="testimonial-wrap">
                <div class="testimonial-item">
                  <img src="assets/img/magaz.jpg" class="testimonial-img" alt="">
                  <h3>Tighrmine</h3>
                  <h4>Store Owner</h4>
                  <p>
                    <i class="bx bxs-quote-alt-left quote-icon-left"></i>
            ...
            <div class="swiper-slide">
              <div class="testimonial-wrap">
                <div class="testimonial-item">
                  <img src="assets/images/Taddart.jpeg.jpg" class="testimonial-img" alt="">
                  <h3>Ighil Ouantar</h3>
                  <h4>Freelancer</h4>
                  <p>
                    <i class="bx bxs-quote-alt-left quote-icon-left"></i>
            ...
            <div class="swiper-slide">
              <div class="testimonial-wrap">
                <div class="testimonial-item">
                  <img src="assets/images/tassift.jpeg.jpg" class="testimonial-img" alt="">
                  <h3>Ighil Melloulen</h3>
                  <h4>Entrepreneur</h4>
                  <p>
                    <i class="bx bxs-quote-alt-left quote-icon-left"></i>
            ...
            <div class="swiper-slide">
              <div class="testimonial-wrap">
                <div class="testimonial-item">
                  <img src="assets/img/tighrmin.jpg" class="testimonial-img" alt="">
                  <h3>Imoula</h3>
                  <h4>Ceo &amp; Founder</h4>
                  <p>
                    <i class="bx bxs-quote-alt-left quote-icon-left"></i>
            ...
            <div class="swiper-slide">
              <div class="testimonial-wrap">
                <div class="testimonial-item">
                  <img src="assets/images/photo.jpg" class="testimonial-img" alt="">
                  <h3>Iazouzène</h3>
                  <h4>Ceo &amp; Founder</h4>
                  <p>
                    <i class="bx bxs-quote-alt-left quote-icon-left"></i>
        ...
        <div class="row" >
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="course-item">
              <img src="assets/images/h9.jpg" class="img-fluid" alt="...">
              <br><br>
              ...
              <div class="course-content">
                ...
                <p>M-Cisna est une commune historique qui a connue beaucoup d'evenements lors de la guerre d'algerie , sachant que beaucoup de citoyens ont participé a la revolution et sont tombés au champ d'honneur afin de liberer ldz.</p>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0">
            <div class="course-item">
              <img src="assets/images/e3.jpg" class="img-fluid" alt="...">
              <div class="course-content">
                <div class="d-flex justify-content-between align-items-center mb-3">
                  <h4>Economie</h4>

                </div>
                <p>Comme toute region de la kabylie M'Cisna est riche l'huile d'olive et ses terre .. .</p>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0">
            <div class="course-item">
              ...
              <div class="course-content">
                ...
                <p>La jeunesse de M'cisna pratique le sport ils ont beaucoup de salle de sport ainsi un stade communal et des clubs sportifs des foyer de juenesse.</p>
