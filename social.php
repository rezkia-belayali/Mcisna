...
<header id="header" class="fixed-top">
  ...
  <main id="main">
   ...
   <div class="container">
    <h1>I.A.I.G</h1>
    <p>
        <strong> dossier a fournir: </strong><br>
        
        Demande manuscrite.  <br>   
        02 Actes de naissances (N°12)<br>
        02 fiches individuelles ou familiales.<br>
        02 Photos d’identité.<br>
        Attestation de non activité/Non activité conjoint.<br>
        Fiche de résidence.<br>
        Attestation de non affiliation à la CNAS. <br>
        Déclaration sur l’honneur. <br>
        <a href="https://www.interieur.gov.dz/index.php/fr/circulation-de-personnes/la-carte-nationale-d-identite.php#faqnoanchor" class="get-started-btn">pour la demande en ligne</a>
      </p>
    <h1>L'AFS</h1>
    <p>
      <strong> dossier a fournir: </strong><br>
      ...
      Fiche de résidence.<br>
      Attestation de non affiliation à la CNAS. <br>
      Attestation de non affiliation a la CASNOS.<br>
      Attestation de non perception a la CNR.<br>
      Copie de jugement de divorce pour les divorcées.<br>
      Acte de décès de l’époux pour les veuves.<br>
      Questionnaire médical pour les personnes atteintes d’une maladie chronique.<br>
      Photocopie de la carte d’handicapé. <br>
  
       <a href="https://www.interieur.gov.dz/index.php/fr/mes-d%C3%A9marches-administratives/passeport-biom%C3%A9trique.php#faqnoanchor" class="get-started-btn">voir plus</a>
    </p>
    <h1>Pension  d’handicapé   à  100%</h1>
    <p>
      <strong> dossier a fournir: </strong><br>
      Demande  manuscrite.<br>
      02 Actes de naissances .<br>
      Fiche de résidence.<br>
      Questionnaire médical établit par un spécialiste<br>
      02 Photos .<br>
      (02) Extrait  de  rôle.<br>
      Photocopie de la carte d’handicapé à  100%.<br>
      Attestation de non affiliation à la CNAS. <br>
      Attestation de non affiliation a la CASNOS.<br>
      Attestation de non perception a la CNR  (pour  les  plus  de  60 ans ).<br>
      Attestation  de  non  perception  de  revenus  délivrée  après  enquête  de  l’ A.P.C.<br>
      Attestation  de  démunis.<br>
    <a href="https://www.interieur.gov.dz/index.php/fr/mes-d%C3%A9marches-administratives/permis-de-conduire.php#faqnoanchor" class="get-started-btn">voir plus</a>
    </p>
    <h1>Assurance pour handicapé   à  100%</h1>
    <p>
      <strong> dossier a fournir: </strong><br>
      
    01 Acte  de  naissance..<br>
    Fiche familiale ou individuelle.<br>
    Fiche de résidence.<br>
    Attestation de non activité.<br>
    Photocopie de la carte d’handicapé.<br>
    Photocopie de la décision.<br>
    <a href="https://www.interieur.gov.dz/index.php/fr/mes-d%C3%A9marches-administratives/permis-de-conduire.php#faqnoanchor" class="get-started-btn">voir plus</a>
    </p>
   </div>
    </section>
