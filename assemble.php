...
<header id="header" class="fixed-top">
  ...
  <main id="main" data-aos="fade-in">
    ...
    <div class="breadcrumbs">
      <div class="container">
        <h2>Assemblée communale</h2>
      <p>L'Assemblée communale populaire (APC) constitue l'assise de la décentralisation et le lieu de la participation des citoyens à la gestion des affaires publiques , ce qui refléte la démocratie.<br>
        L'Assemblée communale populaire est une assemblée élue , composée de membres élus au suffrage universal, direct est secret , pour une durée de 5ans. Elle se réunit en session ordinaire tous les deux mois et peut se réunir en session extraordinaire chaque fois que les affaires de la commune le réquièerent à la demande de son président ou des deus tiers ou la demande du wali . Sur le plan de l'organisation intérieure , l'APC forme des commissions permanentes.<br>
        L'Assemblée populaire communale régle les affaires relevant de ses compétences, Les délibérations sont prises à la majorité simple de ses membres présents ou représentés au moment du vote. En cas de partage égal des voix , celle du président test prépondérante. Les délibérations de l'APC sont exécutoires de plein droit vingt et un jours après leurs dépots à la wilaya .<br>
        ...
        <div class="row" data-aos="zoom-in" data-aos-delay="100">
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="member">
              <img src="assets/img/trainers/trainer-1.jpg" class="img-fluid" alt="">
              <div class="member-content">
                <h4>Benbellil Larbi </h4>
                <p>
                  Adjoint de président de l'APC
                </p>
                <div class="social">
                  <a href=""><i class="bi bi-twitter"></i></a>
                  <a href=""><i class="bi bi-facebook"></i></a>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="member">
              <img src="assets/img/trainers/trainer-1.jpg" class="img-fluid" alt="">
              <div class="member-content">
                <h4>Anares Abdrezik</h4>
                <p>
                 Président commission economique d'ivestissement
                </p>
                <div class="social">
                  <a href=""><i class="bi bi-twitter"></i></a>
                  <a href=""><i class="bi bi-facebook"></i></a>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="member">
              <img src="assets/img/trainers/trainer-1.jpg" class="img-fluid" alt="">
              <div class="member-content">
                <h4>Boullak Kheir-eddin</h4>
                <p>
                  Délégué antenne administrative I.ouanter
                </p>
                <div class="social">
                  <a href=""><i class="bi bi-twitter"></i></a>
                  <a href=""><i class="bi bi-facebook"></i></a>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="member">
              <img src="assets/img/trainers/trainer-1.jpg" class="img-fluid" alt="">
              <div class="member-content">
                <h4>Hamaouni Mustapha</h4>
              
                <p>
                  Membre de l'aasemblée
                </p>
                <div class="social">
                  <a href=""><i class="bi bi-twitter"></i></a>
                  <a href=""><i class="bi bi-facebook"></i></a>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="member">
              ...
              <div class="member-content">
                <h4>Louahab Farid</h>
                <p>
                  Président commisssion sociale jeunesse et sport 
                  </p>
                <div class="social">
                  <a href=""><i class="bi bi-twitter"></i></a>
                  <a href=""><i class="bi bi-facebook"></i></a>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="member">
              <img src="assets/img/trainers/trainer-1.jpg" class="img-fluid" alt="">
              <div class="member-content">
                <h4>Azeboudj Zahir</h4>
                <p>
                  Président commission amenagement du terrtoire urbanisme santé hygiene et protection de l'environement
                </p>
                <div class="social">
                  <a href=""><i class="bi bi-twitter"></i></a>
                  <a href=""><i class="bi bi-facebook"></i></a>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="member">
              ...
              <div class="member-content">
                ...
                <p>
                  Membre de l'assemblée de l'APC
                </p>
                <div class="social">
                  <a href=""><i class="bi bi-twitter"></i></a>
                  <a href=""><i class="bi bi-facebook"></i></a>
